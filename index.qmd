...
- Des *[mapping parties](https://wiki.openstreetmap.org/wiki/FR:Cartoparties)* régulières pour former des débutants à éditer OSM collectivement : [25 événements](https://wiki.openstreetmap.org/wiki/Current_events) à travers le monde en mai 2025 ! 
...
Les études s'intéressent généralement à la complétude de tags clés et à leur consistance (mauvais tags, comparaison avec des bases de données de référence).
...
**[valh](https://github.com/riatelab/osrm)** (Giraud, Viry, 2025) propose peu ou prou les mêmes fonctionnalités qu'osrm, et permettant la création de [profils de routage](https://valhalla.github.io/valhalla/api/turn-by-turn/api-reference/#costing-models) personnalisés. 
...
[valh](https://github.com/riatelab/osrm) réalise l'interface en R et l'API **[Valhalla](https://valhalla.github.io/valhalla/)**. Ce [site web](https://valhalla.openstreetmap.de/) permet de jouer sur les paramètres de l'API, comme les *[costing options](https://valhalla.github.io/valhalla/api/turn-by-turn/api-reference/#costing-models)*. 

![](img/valhalla.png)
<small>

Cette [vignette](https://cran.r-project.org/web/packages/valh/vignettes/install-valhalla.html) décrit comment installer son propre serveur Valhalla pour des requêtes importantes. À noter que dans ces configurations, OSRM présente des performances plus importantes.  
...
Les packages R [leaflet](https://rstudio.github.io/leaflet/), [mapview](https://r-spatial.github.io/mapview/) ou [maptiles](https://github.com/riatelab/maptiles) proposent la visualisation de tuiles raster stylisées à différents niveaux de zoom open source comme [Stamen](https://r-spatial.github.io/mapview/) ou [Thunderforest](https://www.thunderforest.com/), qui sont tirées d'OSM
...
- OSM: 20 ans d'exitence. Une **communauté** qui **grandit**, la **qualité** qui **s'améliore**, des **usages** qui se **diversifient** et des outils (extraction de données, saisie de données, routage, stylisation de tuiles raster, évaluation qualité) qui se **multiplient**
