...
here <- geo(address = "5 Cours des Humanités, 93300 Aubervilliers, France", 
            quiet = TRUE) |>
...
res <- om_get(x = here, r = 2000, quiet = TRUE)

# En faire la carte
om_map(res, title = "A 2000 mètres d'ici")
mf_map(here, add = TRUE)
```
...
# Résultat
om_map(res, title = "A 2000 mètres d'ici")
mf_map(here, pch = 22, cex = 2.2, bg = "darkred", add = TRUE)
mf_map(thai, pch = 21, cex = 2.2, bg = "black",  add = TRUE)
mf_label(thai, var = "name", pos = c(3, 4, 2, 2, 4))
```
...
mf_map(ped, lwd = 5, col = "#238b45", add = TRUE)
mf_map(here, pch = 22, cex = 2.2, 
       bg = "white", add = TRUE)
mf_map(thai, pch = 21, cex = 2.2, 
       bg = "#005a32",  add = TRUE)
mf_label(thai, var = "lab_ped", pos = c(2, 4, 4, 2, 4))
...
mf_map(bik, lwd = 5, col = "#e31a1c", 
       add = TRUE)
mf_map(here, pch = 22, cex = 2.2, 
       bg = "white", add = TRUE)
mf_map(thai, pch = 21, cex = 2.2, 
       bg = "#800026",  add = TRUE)
mf_label(thai, var = "lab_bik", pos = c(2, 4, 4, 2, 4))
