...
## Jouer l'exercice pratique tout à l'heure...

<center>

Nécessite l'installation de plusieurs packages R... et une connexion internet 
...
**Packages pour interfacer des données OpenStreetMap**
...
**Packages pour manipuler des données spatiales et les cartographier**
...
library(stplanr) # segmenter des lignes
library(mapview) # cartographie interactive
library(lwgeom) # gestion géométrique des itinéraires
library(mapiso) # vectoriser un raster
```
...
**Instructions d'installation** : [https://github.com/riatecom/osm-elementr-2025-application](https://github.com/riatecom/osm-elementr-2025-application)
